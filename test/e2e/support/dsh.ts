...
const ASSEMBLED_DSH = join(APPDATA_BASE, 'com.seuwanglab.wanglab-harness-desktop', DSH_BIN_REL_PATH)

const UPSTREAM_ASSEMBLED_DSH = join(APPDATA_BASE, 'dsh-tauri', DSH_BIN_REL_PATH)
...
export function resolveDshCommand(): string[] {
  ...
  if (existsSync(UPSTREAM_ASSEMBLED_DSH))
    return [UPSTREAM_ASSEMBLED_DSH]
