// 引用源 @deepseek-ai/dsh-client-ui-workspace · packages/client/ui-workspace/src/client/rows/WorkspaceBrowser.module.css ; @deepseek-ai/dsh-client-ui-plugin-manager · packages/client/ui-plugin-manager/src/client/PluginManagerPage.module.css ; @deepseek-ai/dsh-client-ui-settings-models · packages/client/ui-settings-models/src/client/ModelsSection.module.css ; @deepseek-ai/dsh-client-ui-sidebar · packages/client/ui-sidebar/src/client/SidebarRoot.module.css ; @deepseek-ai/dsh-client-ui-workspace · packages/client/ui-workspace/src/client/rows/Rows.module.css ; @deepseek-ai/dsh-client-ui-primitives · packages/client/ui-primitives/src/settings-form/fields.module.css ; @deepseek-ai/dsh-client-ui-chat · packages/client/ui-chat/src/client/chat/MessageIconActions.module.css · 版本 0.1.7-alpha.1（≥0.1.5-rc.1）· hash search=searchButton toolbar=iconButton model=iconButton round=iconButton row=iconButton help=helpButton action=action
