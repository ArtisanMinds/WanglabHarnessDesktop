...
export const CMD_LIST_PET_MARKET = 'list_pet_market'
export const CMD_DOWNLOAD_MARKET_PET = 'download_market_pet'
export const CMD_GET_MARKET_PET_PROGRESS = 'get_market_pet_progress'
export const PET_DOWNLOAD_POLL_MS = 400
export const PET_STATUS_SOURCE = 'dsh-desktop-pet'
export const PET_STATUS_MESSAGE = 'dsh://pet:status'
