import type { MarketPetItem, PetMarketSnapshot, PresetDownloadProgress } from '../types/market'
import { createLifecycleController, invoke } from 'dsh-tauri/client'

const CMD_DOWNLOAD_MARKET_PET = 'download_market_pet'
const CMD_GET_MARKET_PET_PROGRESS = 'get_market_pet_progress'
const CMD_LIST_PET_MARKET = 'list_pet_market'
const PET_DOWNLOAD_POLL_MS = 400
