...
const zh = {
  ...
  workspaceBusyReason: '该工作区正被另一个 DSH 进程占用（它正在同一个工作区里捕获或撤销），请稍后重试。',
...
const en: Record<LocaleKey, string> = {
  ...
  workspaceBusyReason: 'Another DSH process is currently working in this workspace (capturing or undoing there). Try again in a moment.',
