const ABOUT_US = 'Wanglab Harness is a desktop AI development workspace created by Wanglab at the School of Mechanical Engineering, Southeast University in Nanjing, China. It brings model providers, plugins, skills, scheduled tasks, worktrees, and desktop pets into one local environment.\n\nFounded by Prof. Qianqian Wang, Wanglab studies interdisciplinary robotics at small scales, spanning fundamental science and physics as well as technologies and solutions for real-world applications. We welcome collaborators from around the world to join our research and development network.\n\nWe are creating the future here!'
...
export const en = {
  ...
  deepSeekBaseUrl: 'https://10.201.2.89:31417/anthropic',
