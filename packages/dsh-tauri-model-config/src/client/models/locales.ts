export const en = {
  ...
  fetchModelConfigHint: 'Read this model\'s configuration from the endpoint',
  autoConfigureModels: 'Configure all models',
  autoConfigureModelsHint: 'Read configuration for every listed model from the endpoint',
  fetchingConfig: 'Fetching…',
  configUnreachable: 'Could not read the model list: {detail}',
  configNoneApplied: 'The endpoint disclosed no new configuration for these models.',
  configApplied: 'Applied configuration to {n} model(s).',
}
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  fetchModelConfigHint: '从端点读取该模型的配置',
  autoConfigureModels: '自动配置所有模型',
  autoConfigureModelsHint: '从端点读取列表中每个模型的配置',
  fetchingConfig: '获取中…',
  configUnreachable: '无法读取模型列表：{detail}',
  configNoneApplied: '端点没有为这些模型披露任何新配置。',
  configApplied: '已为 {n} 个模型填入配置。',
}
