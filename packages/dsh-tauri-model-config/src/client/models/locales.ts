export const en = {
  ...
  openConfigFileFailed: 'Could not open the config file: {detail}',
  ...
  templateThinking: 'Local endpoint thinking',
  templateThinkingHint: 'vLLM-style OpenAI-compatible servers read the effort from chat_template_kwargs and accept only the system role; writes compat thinkingFormat=chat-template, chatTemplateKwargs.reasoning_effort={$var: thinking.effort} and supportsDeveloperRole=false',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  openConfigFileFailed: '无法打开配置文件：{detail}',
  imageInput: '支持图片输入',
  imageInputHint: '声明该模型是否接受图片内容',
  thinkingMode: '思考模式',
  thinkingLevels: '思考档位',
  thinkingModeHint: '声明该模型是否支持思考，并勾选它提供的档位',
  templateThinking: '本地端点思考',
  templateThinkingHint: 'vLLM 等 OpenAI 兼容端点从 chat_template_kwargs 读取思考档位，且只认 system 角色；开启后写入 compat：thinkingFormat=chat-template、chatTemplateKwargs.reasoning_effort={$var: thinking.effort}、supportsDeveloperRole=false',
